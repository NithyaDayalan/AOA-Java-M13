...
## Algorithm:
1. Read the 9×9 Sudoku board from the user, using 0 for empty cells.
2. For each empty cell, try placing numbers 1 to 9.
3. Check if the number placement is safe in the current row, column, and 3×3 subgrid.
4. Use recursion and backtracking to fill all cells correctly.
5. Print the solved board if a solution exists; otherwise, indicate no solution.  
...
## Output:
<img width="807" height="556" alt="image" src="https://github.com/user-attachments/assets/b076c766-fad1-489c-a21b-1ec25ec0fac4" />
